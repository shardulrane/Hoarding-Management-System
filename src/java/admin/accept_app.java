 ...
 * @author shark
 */
public class accept_app extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                if (i != 0) {
                    ...
                    if (rs1.next()) {
                        String msg = "Hello User Your Application No:" + id + " For Hoarding Is Accepted You Can Now Proceed To Pay The Respective Amount.";
                        mailclass mc = new mailclass(rs1.getString("username"), msg);
                        //sesssion.invalidate();
                    }
                    out.println("<script>alert('Approved And Notified !!!')\n" + "  window.location.href='admin/view_application.jsp';\n" + "</script>");
